...
namespace yeetong_ProtocolAnalysis
{
    public class ProtocolAnalysisSE_Main
    {
        ...
        public static void ProtocolPackageResolver_TowerCrane(byte[] b, int c, TcpSocketClient client)
        {
            ...
            {
                case 0xA5:
                    yeetongTower0xA5(b, c, client);
                    break;
                case 0x7E:
                    yeetongTower0x7E(b, c, client);
                    break;
            }
        }
        #region 0x7E开头的处理
        static OnResolveRecvMessagedelegate OnResolveRecvMessagede_7E0E = GprsResolveDataV0E.OnResolveRecvMessage;
        private static void yeetongTower0x7E(byte[] b, int c, TcpSocketClient client)
        {
            ...
            switch (b[2])
            {
                case 0x0E:
                    ...
                    yeetongUnpack(b, c, client, "7E7E0E", "7D7D", OnResolveRecvMessagede_7E0E);
                    break;
                default: break;
            }
        }
        ...
        private static void yeetongTower0xA5(byte[] b, int c, TcpSocketClient client)
        {
            TcpClientBindingExternalClass TcpExtendTemp = client.External.External as TcpClientBindingExternalClass;
            if (b[2] == 0x02 && b[3] == 0x13 && b[4] == 0x03)
            {
                TcpExtendTemp.TVersion = "A55A021303";
                yeetongUnpack(b, c, client, "A55A021303", "EEFF", OnResolveRecvMessagedeV021303);
            }
        }
        #endregion
        #endregion
