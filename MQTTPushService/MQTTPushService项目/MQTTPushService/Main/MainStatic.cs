    ...
    public static class MainStatic
    {
        ...
        static  MainStatic()
        {
            try
            {
                ...
                putServer = ToolAPI.INIOperate.IniReadValue("goyo", "putServer", MainStatic.Path);
                putPort = ToolAPI.INIOperate.IniReadValue("goyo", "putPort", MainStatic.Path);
                putType = ToolAPI.INIOperate.IniReadValue("goyo", "putType", MainStatic.Path);
            }
            catch(Exception ex)
            {
